  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Registration',style: TextStyle(color: Colors.black.withOpacity(0.5)),),
      ),
...
crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      ...
      SizedBox(height: 10,),
      Text('Corporate Name',style: TextStyle(fontSize: 18),),
      SizedBox(height: 5,),
      TextFormField(
      ...
      SizedBox(height: 10,),
      Text('Corporate Number',style: TextStyle(fontSize: 18),),
      SizedBox(height: 5,),
      TextFormField(
